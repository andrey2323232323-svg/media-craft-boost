...
const cases = [
  ...
  },
  {
    ...
    results: [
      "Запуск с 0",
      "Разработана контент-стратегия и визуальный стиль соцсетей",
      "+13 000 в течение года в сообществе во ВКонтакте и Телеграм (таргетинг и интеграции)",
    ],
  },
  {
    ...
    results: [
      "Запуск с 0",
      "Разработана контент-стратегия и визуальный стиль соцсетей",
      "+800 подписчиков в Телеграм, цена от 40 до 60 рублей за подписчика.",
    ],
  },
  {
    title: "Трэвел телеграм-канал",
    services: "Таргетированная реклама",
    number: "07",
    link: "https://t.me/ohwrld",
    results: [
      "Разработана долгосрочная стратегия продвижения",
      "+100 подписчиков в Телеграм, цена от 0,1 евро.",
    ],
  },
];
